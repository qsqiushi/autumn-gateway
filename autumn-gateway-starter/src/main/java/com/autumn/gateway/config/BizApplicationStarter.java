...
public class BizApplicationStarter implements InitializingBean {
  ...
  @Autowired
  public BizApplicationStarter(
      EventManager eventManager,
      IApiDiscovererService apiDiscovererService,
      IServerManager serverManager,
      IPf4jPluginManagerService pf4jPluginManagerService,
      IApiRegisterService apiRegisterService,
      IApiContextManagerService apiContextManagerService,
      Vertx vertx) {
                        ...
                        webSocket.textMessageHandler(
                            msg -> {
                              if (StringUtils.equals("1", msg)) {
                                ...
                                serverManager
                                    .stopServers()
                                    .onSuccess(handler -> log.info("stop success"));
                                ...
                                pluginInfo.setPluginPath(
                                    "/Users/qiushi/ideaProject/qm/agw/agwPluginsAndLogsFolder/plugins/qm-agw-plugin-proxy-http-1.0.0-SNAPSHOT");
                                pluginInfo.setType(Pf4jPluginTypeEnum.COMPONENT_PLUGIN);
